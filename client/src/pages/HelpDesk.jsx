      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 900, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ animation: 'fadeUp .6s cubic-bezier(0.16,1,0.3,1) .2s both' }}>
          ...
          <FAQItem 
            ...
            answer={<>Yes! You can create custom aliases for your links. Instead of a random code like "TinyHop.link/xK9pQ", you can have something memorable like "TinyHop.link/summer-sale". Just enter your desired alias when creating the link.</>}
          />
