...
const FEATURES = [
  ...
  { n: '03', label: 'Custom Aliases', title: 'Your brand in every link.', body: 'TinyHop.link/launch24 earns 3× more clicks than TinyHop.link/xK9pQ. Memorable slugs build trust, reinforce campaigns, and work beautifully in print.', to: '/features/custom-aliases', accent: '#6d28d9', icon: '🎯' },
