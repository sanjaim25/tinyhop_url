...
const FEATURES = [
  ...
  { n: '03', label: 'Custom Aliases', title: 'Your brand in every link.', body: 'tinyhop-url.onrender.com/launch24 earns 3× more clicks than tinyhop-url.onrender.com/xK9pQ. Memorable slugs build trust, reinforce campaigns, and work beautifully in print.', to: '/features/custom-aliases', accent: '#6d28d9', icon: <Target size={24} color="#15141c" strokeWidth={2.5} /> },
